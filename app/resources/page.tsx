...
export const metadata: Metadata = {
    title: "Resources | QENAI - AI Automation Agency Kenya",
    description: "Explore QENAI's projects, case studies, assessments, and FAQs — everything you need to understand and get started with AI automation in Kenya and East Africa.",
    keywords: ["AI automation resources", "AI case studies Kenya", "AI FAQs", "AI automation agency Kenya"],
    alternates: {
        canonical: "/resources",
    },
};
        ...
        <main className="min-h-screen bg-white text-black">
            ...
            <section id="projects" className="section-padding border-b border-gray-100">
                <div className="section-container max-w-6xl mx-auto">
                    ...
                    <p className="body-text text-gray-600 mb-10 max-w-2xl">
                        ...
                        {[
                            ...
                            <div key={i} className="card-primary flex flex-col justify-between">
                                <div>
                                    ...
                                    <h3 className="text-xl font-bold font-serif text-white mb-3">{project.title}</h3>
                        ...
                        {[
                            ...
                            <div key={i} className="card-standard flex flex-col justify-between">
                                <div>
                                    ...
                                    <h3 className="text-2xl font-bold font-serif text-white mb-3">{blog.title}</h3>
                ...
                <div className="section-container max-w-6xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        {[
                            ...
                            <div key={i} className="card-standard flex flex-col justify-between">
                                <div>
                                    <h3 className="text-xl font-bold font-serif text-white mb-3">{paper.title}</h3>
            ...
            <section id="readiness" className="section-padding border-b border-gray-100 bg-gray-50">
                <div className="section-container max-w-6xl mx-auto text-center">
                    ...
                    <div className="card-primary max-w-2xl mx-auto p-12 text-center">
                        <h3 className="text-2xl font-bold font-serif text-white mb-3">Take the Assessment</h3>
