    ...
    <section className="section-padding bg-white">
      <div className="section-container">
        <div className="text-center mb-16">
          <p className="text-xs font-semibold uppercase tracking-[0.22em] text-cyan-600 mb-4">What We Do</p>
          <h2 className="text-4xl md:text-5xl font-bold text-slate-900 tracking-tight">One outcome: AI your team actually uses.</h2>
        </div>
