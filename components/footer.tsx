...
export function Footer() {
    return (
        <footer className="py-20 bg-qen-dark border-t border-white/10 text-white">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-10 text-sm">
                        <div className="space-y-3">
                            ...
                            <ul className="space-y-2 text-white/60">
                                ...
                                <li><Link href="/about#approach" className="hover:text-white transition-colors">Approach</Link></li>
                            </ul>
                        </div>
                        <div className="space-y-3">
                            ...
                            <ul className="space-y-2 text-white/60">
                                ...
                                <li><Link href="#services" className="hover:text-white transition-colors">Integrate</Link></li>
                            </ul>
                        </div>
                        <div className="space-y-3">
                ...
                <div className="border-t border-white/10 pt-8">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                        ...
                        <p className="text-xs text-white/30">
                            &copy; {new Date().getFullYear()} Qenai. All rights reserved.
                        </p>
                        ...
                        <div className="flex items-center gap-5">
                            {/* LinkedIn */}
                            <a
                                href="https://www.linkedin.com/company/qenaico/?viewAsMember=true"
                                target="_blank"
                            ...
                            {/* Facebook */}
                            <a
                                href="https://www.facebook.com/profile.php?id=61587141206366"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-white/40 hover:text-white transition-colors"
                                aria-label="Facebook"
